...
(() => {
  ...
  // ../lib/src/hotkeys/prefix-hint-badge.ts
  ...
  // ../lib/src/hotkeys/prefix-background.ts
  ...
  // ../lib/src/extension-icon-state/tab-active-state.ts
  ...
  // ../lib/src/extension-icon-state/icon-sync.ts
  ...
  // ../lib/src/extension-icon-state/listeners.ts
  ...
  // ../lib/src/extension-icon-state/create.ts
  ...
  // ../lib/src/badge/text-color-animation.ts
  ...
  // ../lib/src/panel-popup/open-action-popup.ts
  ...
  // ../lib/src/page-operability/can-operate.ts
  ...
  // ../lib/src/page-operability/show-notice.ts
  ...
  // ../lib/src/page-operability/messages.ts
