...
const MESSAGES: Record<Locale, Strings> = {
  en: {
    ...
    selectionCaptionStyleLabel: "On the frame",
  ...
  es: {
    ...
    selectionCaptionStyleLabel: "En el marco",
  ...
  fr: {
    ...
    selectionCaptionStyleLabel: "Sur le cadre",
  ...
  de: {
    ...
    selectionCaptionStyleLabel: "Am Rahmen",
  ...
  ru: {
    ...
    selectionCaptionStyleLabel: "На рамке",
  ...
  zh_CN: {
    ...
    selectionCaptionStyleLabel: "框上显示",
  ...
  ar: {
    ...
    selectionCaptionStyleLabel: "على الإطار",
